        ...
        <header>
          <Navbar bg="dark" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand> WonderCart </Navbar.Brand>
              </LinkContainer>
        ...
        <main>
          <Container className="mt-3">
            <Routes>
              ...
              <Route path="/payment" element={<ProtectedRoute><PaymentMethodScreen /></ProtectedRoute>} />
              ...
              <Route path="/admin/banners" element={<AdminRoute><AdminBannerScreen /></AdminRoute>} />
