...
function ProductScreen() {
  ...
  const addToWishlistHandler = () => {
    // Ensure wishlist is defined
    const wishlistItems = wishlist && wishlist.wishlistItems ? wishlist.wishlistItems : [];
    ...
    if (existItem) {
        ...
        return; // Exit if item is already in wishlist
    }
                ...
                {product.countInStock > 0 && (
                  <ListGroup.Item>
                    <div className="d-grid">
                      ...
                      <Button onClick={addToWishlistHandler} variant="outline-secondary">
                        Add to Wishlist
                      </Button>
                    </div>
                  </ListGroup.Item>
